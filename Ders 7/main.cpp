...
void setupScene(){
    ...
    pad2 = new DiffusePerPixelNode("Batman.obj");

	plane= new DiffusePerPixelNode("capsule.obj");
	plane->rotate(-90,1,0,0);
	plane->scale(1000.f,1000.f,1000.f);
	
	
    pad1->translate(50, 0, -100);
    
    pad2->translate(150, 0, 0);
    ...
    camera = new Camera();
    camera->rotate(-40,0,1,0);
	camera->rotate(-20,1,0,0);
    camera->translate(-300.f, 400.f, 400.f);
	//camera->translate(0.f, 600.f, 600.f);
   ...
   // scene->addEffect(new SimpleEffect(&CurrentWidth,&CurrentHeight));
    ...
    light = new Light();
    light->translate(300.f, 0.f, -300.f);
	light->rotateSpot(-0.8,-0.8,0);
